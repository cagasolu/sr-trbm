...
The temperature is treated as a **dynamical state variable rather than a fixed hyperparameter**.
...
- Persistent Contrastive Divergence (PCD-K, K ∈ ℕ)  
...
Multi-GPU execution is supported in PyTorch via explicit CUDA device binding.
